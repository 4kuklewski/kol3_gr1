    ...
    def start(self):
        ...
        while True:
            ...
            if int(self.choice) >= 0 and int(self.choice) < len(self.students):
                condition2 = True
                while condition2:
                    self.student = diary.Diary(self.students[int(self.choice)][0], self.students[int(self.choice)][1],
                                               self.students[int(self.choice)][2], self.students[int(self.choice)][3])
